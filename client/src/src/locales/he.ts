...
export const he = {
  ...
  auth: {
    ...
    invalidCredentials: "המייל או הסיסמה אינם נכונים",
    emailRequired: "יש להזין אימייל",
    passwordRequired: "יש להזין סיסמה",
    passwordTooShort: "הסיסמה קצרה מדי",
    passwordMinLengthHint: "הסיסמה צריכה להכיל לפחות {min} תווים",
    passwordLooksGood: "הסיסמה תקינה ואפשר להמשיך",
    ...
    fullNameTooShort: "השם המלא חייב להכיל לפחות 2 תווים",
