...
function initNagishLi() {
  ...
  $NagishLi(function (a) {
    ...
    function y(b, c) {
      "TL" == b
        ...
        : "BR" == b
          ...
          : "TR" == b
            ? (a(commons.bar)[0].style.setProperty(
                "bottom",
                "auto",
                "important",
              ),
    ...
    e +=
      ...
      commons.menus +
      ".orange > .nl-dropdown:last-child > .nl-dropdown-menu > li:last-child > div { border-color: #ff8c00d0 !important; }";
    e +=
      commons.menus +
              ...
              a(commons.dd + " > .nl-dropdown-toggle").each(function () {
                ...
                if (
                  ...
                  a(this).next("#NagishLiHighlight", "ul").length &&
                    (!a(this).children("span.selected").length &&
                    1 <
                      a(this).next("ul").children("li.active").find("span.sign")
                        .length
                      ? ((b =
                          a(this)
                            .next("ul")
